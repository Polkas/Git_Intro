**This is a summary of the Version Control with Git - Atlassian course offered by Coursera**

[**Version Control with Git**](https://www.coursera.org/learn/version-control-with-git)

The presentation with a summary of the course done with command line is in the `Git_Intro` files.
There was written some extansions to the topic if needed.
